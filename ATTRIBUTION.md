...
Free Family Display ships photographs that other people made and licensed for
reuse. The software is Apache 2.0 (see `LICENSE`); **these images are not** —
each one stays under its own licence, listed below.

Generated from `apps/web/public/wallpapers/manifest.json` and
`apps/web/public/login-photos/credits.json`, which are also what the app reads
to print the credit on screen. Regenerate with `npm run attribution`.

## Wallpaper collections

### Deep space

Nebulae, deep fields, Mars, and Earth from orbit. NASA and ESA imagery — public domain.

| Image | Photographer | Source | Licence |
| --- | --- | --- | --- |
| `lagoon-nebula` | NASA, ESA, Hubble | [NASA Image Library](https://images.nasa.gov/details/GSFC_20171208_Archive_e001955) | Public domain |
| `crab-nebula` | NASA, ESA, J. Hester and A. Loll (ASU) | [NASA Image Library](https://images.nasa.gov/details/PIA03606) | Public domain |
| `webb-deep-field` | NASA, ESA, CSA, STScI | [NASA Image Library](https://images.nasa.gov/details/webb_first_deep_field) | Public domain |
...
Ridgelines, glacial valleys, and high lakes.
...
Classic iron, chrome, and hot rods.
...
Fire rings, sparks and dark woods. Warm light against a lot of dark — easy to read a clock over.

| Image | Photographer | Source | Licence |
| --- | --- | --- | --- |
| `bramble-embers` | Alasdair | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Campfire_at_Bramble_Bield.jpg) | CC BY 2.0 |
| `flame-close` | Free Nature Stock | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Campfire_Flames.jpg) | CC0 |
| `lake-tahoe` | tahoesignatureproperties.com | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Campfire_by_Lake_Tahoe.jpg) | CC BY-SA 4.0 |
| `under-the-stars` | Nicholas Jones | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Campfire_under_the_stars_at_Serpentine_Chalet_-_Flickr_-_whale05.jpg) | CC BY 2.0 |
| `sparks` | Abrget47j | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Kaberneeme_campfire_site.jpg) | CC BY-SA 3.0 |
...
Neon arcade cabinets and machined hardware. Deep blacks with pink and cyan edges.

| Image | Photographer | Source | Licence |
| --- | --- | --- | --- |
| `neon-joysticks` | PattayaPatrol | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:DFC_0797_Close-up_of_a_row_of_retro_arcade_game_joysticks_glowing_with_neon_blue_and_pink_lights.jpg) | CC BY-SA 4.0 |
| `cabinet-glow` | PattayaPatrol | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:DFC_0798_Close-up_of_illuminated_arcade_claw_machines_with_glowing_joysticks_and_neon_accents.jpg) | CC BY-SA 4.0 |
| `pink-row` | PattayaPatrol | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:DFC_2198_A_row_of_brightly_lit_claw_machines_glowing_in_pink_neon_each_filled_with_stuffed_toys_waiting_to_be_won.jpg) | CC BY-SA 4.0 |
| `arcade-street` | PattayaPatrol | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:DFC_2600_Two_people_stand_inside_a_small_arcade_filled_with_brightly_lit_claw_machines_the_storefront_glowing_in_neon_pink_and_purple_against_the_night_street.jpg) | CC BY-SA 4.0 |
...
Lakes, pines, snow, fog, and birch woods across the Upper Midwest. Calm and quiet.

| Image | Photographer | Source | Licence |
| --- | --- | --- | --- |
| `andrew-lake-dock` | Tony Webster | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Andrew_Lake_Sunset_-_Dock_at_Sibley_State_Park_-_Minnesota.jpg) | CC BY 2.0 |
| `little-gabro-lake` | Dankarl | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Little_Gabro_Lake,_clouds,_approaching_sunset_765.jpg) | CC BY-SA 4.0 |
| `misty-pines` | Greg Zaal | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Misty_pines_%E2%80%93_Panorama_(Greg_Zaal_via_Poly_Haven).jpg) | CC0 |
| `birch-winter-stream` | Emil Boehl | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Winter_scene_in_Forest_Park_with_stream_cutting_through_snow-covered_ground_and_small_pavilion_in_distance_seen_through_birch_trees.jpg) | Public domain |
| `upson-lake-road-autumn` | Tony Webster | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Upson_Lake_Road_-_Autumn_in_Northern_Wisconsin_(49044933032).jpg) | CC BY-SA 2.0 |
...
Skylines, bridges, and wet streets after dark. Deep blacks with bright accents — pairs well with the arcade collection.

| Image | Photographer | Source | Licence |
| --- | --- | --- | --- |
| `chicago-skyline-night` | Matt Kieffer | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Chicago_skyline_at_night_from_360_Chicago_observation_deck_(49712821158).jpg) | CC BY-SA 2.0 |
| `nyc-skyline-from-esb` | Jody Claborn | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:New_York_City_Skyline_from_Top_of_Empire_State_Building.jpg) | Public domain |
| `hong-kong-harbour-night` | Benh LIEU SONG | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Hong_Kong_Harbour_Night_2019-06-11.jpg) | CC BY-SA 4.0 |
| `sf-bay-bridge-night` | Dllu | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:San_Francisco_Bay_Bridge_Western_Span_at_night.jpg) | CC BY-SA 4.0 |
| `wet-street-neon-reflection` | PattayaPatrol | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:DFC_0505_Neon-lit_city_street_at_night_reflected_in_a_rain_puddle_colorful_signs_and_lights_mirrored_on_the_wet_pavement.jpg) | CC BY-SA 4.0 |
...
Supercells, lightning, mammatus, and shelf clouds. Pairs with the weather widget.

| Image | Photographer | Source | Licence |
| --- | --- | --- | --- |
| `supercell-over-lake` | Šime Barešić | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Supercell_059.jpg) | CC0 |
| `supercell-bell-bottom-updraft` | Rollingskyphoto | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Supercell_with_bell-bottom_updraft.jpg) | CC BY 4.0 |
| `lightning-from-orbit` | NASA Johnson Space Center / Kimiya Yui | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Bright_lightning_storms_illuminate_the_cloudy_landscape_of_western_Africa_(iss073e0816985).jpg) | Public domain |
| `mammatus-sunset` | Cbaile19 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Mammatus_clouds,_Pittsburgh,_2022-06-16,_04.jpg) | CC0 |
| `shelf-cloud-new-jersey` | Anthony Quintano | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Shelf_Cloud_Over_Mount_Laurel_New_Jersey_August_11,_2021_(51372605582).jpg) | CC BY 2.0 |
...
Anything a household adds to its own instance — its own photos, a linked
album, or art fetched by tag — is never committed here and is never
